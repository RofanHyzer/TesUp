...
function Logo(efek, teks1, teks2) {
    try {
    if (efek == "kaneki") {
        return "https://api.caliph.biz.id/api/kaneki?nama=" + teks1 + "&apikey=ZXcYZjjW"
        } else if (efek == "lolimaker") {
        return "https://api.caliph.biz.id/api/lolimaker?nama=" + teks1 + "&nama2=" + teks2 + "&apikey=ZXcYZjjW"
        } else if (efek == "girlneko") {
        return "https://api.caliph.biz.id/api/girlneko?nama=" + teks1 + "&nama2=" + teks2 + "&apikey=ZXcYZjjW"
        } else if (efek == "rem") {
        return "https://api.caliph.biz.id/api/rem?nama=" + teks1 + "&apikey=caliphkey"
        } else if (efek == "sadboy") {
        return "https://api.caliph.biz.id/api/sadboy?nama=" + teks1 + "&nama2=" + teks2 + "&apikey=ZXcYZjjW"
        }
    } catch (e) {
        throw eror
    }
